...
<table>
    ...
    <td width="75%" valign="top">
        ...
        <label for="toggle" style="margin-top: -20px;">[YouTube Video]</label>
        <div class="expand">
            <section>
...
<table width="100%">
    ...
    <td width="75%" valign="top">
        ...
        <label for="toggle2" style="margin-top: -20px;">[YouTube Video]</label>
        <div class="expand">
            <section>
...
<table width="100%">
    ...
    <td width="75%" valign="top">
        ...
        <label for="toggle3" style="margin-top: -20px;">[YouTube Video]</label>
        <div class="expand">
            <section>
